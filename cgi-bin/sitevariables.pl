...
$photoroot ='/var/www/localhost/html/pictures';
...
#descriptions, etc.
$dataroot ='/var/www/localhost/html/photodata';
...
$allowcomments = ''; # allow comments on each pictures?
$indicate_comments = ''; # put a small icon next to thumbnails with comments?
$smiley = ''; # replace things like :-) with a smiley face?
